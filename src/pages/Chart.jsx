            ...
            <aside className="w-72 border-r border-slate-800/50 flex flex-col bg-slate-900/20 backdrop-blur-xl z-20">
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-2 custom-scrollbar">
                    {stocks
                        ...
                        .map((s,idx) => (
                        <div key={idx} onClick={() => setSelectedSymbol(s.name)} className={`p-4 rounded-4 cursor-pointer transition-all mb-2 ${selectedSymbol === s.name ? 'bg-primary bg-opacity-10 border border-primary border-opacity-30' : 'bg-slate-900/40 border border-slate-800/50 hover-bg-slate-800'}`}>
