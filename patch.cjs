...
let content = fs.readFileSync("src/components/tradingModals/OptionChain.jsx", "utf-8");
...
fs.writeFileSync("src/components/tradingModals/OptionChain.jsx", content, "utf-8");
